 ...
 */
package com.mycompany.proyectofinalpapw.utils;
...
public class DbConnection {
    ...
    static {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/dbpapw?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        // El nombre de usuario de su conexion
        dataSource.setUsername("root");
        // La contraseña del usuario de su conexion
        dataSource.setPassword("progra99");
