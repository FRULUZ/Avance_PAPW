 ...
 * @author EDGAR
 */
@WebServlet(name = "ModificarUserController", urlPatterns = {"/ModificarUserController"})
@MultipartConfig(maxFileSize = 1024 * 1024 * 5, maxRequestSize = 1024 * 1024 * 25)
public class ModificarUserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        User user = new User(id, username, password, correo, FileUtils.RUTE_USER_IMAGE + "/" + nameImage, red, about); 
          
      
        
       UserDAO.modificar_user(user);
